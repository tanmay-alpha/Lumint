          ...
          <AnimatePresence mode="wait">
            {isAnalyzing ? (
              ...
              >
                <EmptyStateWithCTA
                  icon="search"
                  title="DocShield is a demo module"
                  description="Document forensics requires server-side ELA computation and metadata extraction. Try UPI Shield for a fully working demo."
